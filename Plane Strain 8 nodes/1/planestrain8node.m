...
a=(y5*(2*s^2 - 2))/4 - (y8*(4*t - 4*s*t))/4 - (y6*(4*t + 4*s*t))/4 - (y7*(2*s^2 - 2))/4 - (y2*(s - 2*t - 2*s*t + s^2))/4 + (y3*(s + 2*t + 2*s*t + s^2))/4 + (y1*(s + 2*t - 2*s*t - s^2))/4 - (y4*(s - 2*t + 2*s*t - s^2))/4;
b=(y4*(2*s - t + 2*s*t - t^2))/4 - (y7*(4*s + 4*s*t))/4 - (y5*(4*s - 4*s*t))/4 - (y6*(2*t^2 - 2))/4 + (y8*(2*t^2 - 2))/4 + (y3*(2*s + t + 2*s*t + t^2))/4 + (y1*(2*s + t - 2*s*t - t^2))/4 + (y2*(2*s - t - 2*s*t + t^2))/4;
c=(x4*(2*s - t + 2*s*t - t^2))/4 - (x7*(4*s + 4*s*t))/4 - (x5*(4*s - 4*s*t))/4 - (x6*(2*t^2 - 2))/4 + (x8*(2*t^2 - 2))/4 + (x3*(2*s + t + 2*s*t + t^2))/4 + (x1*(2*s + t - 2*s*t - t^2))/4 + (x2*(2*s - t - 2*s*t + t^2))/4;
d=(x5*(2*s^2 - 2))/4 - (x8*(4*t - 4*s*t))/4 - (x6*(4*t + 4*s*t))/4 - (x7*(2*s^2 - 2))/4 - (x2*(s - 2*t - 2*s*t + s^2))/4 + (x3*(s + 2*t + 2*s*t + s^2))/4 + (x1*(s + 2*t - 2*s*t - s^2))/4 - (x4*(s - 2*t + 2*s*t - s^2))/4;

dNs=[ - ((s - 1)*(t - 1))/4 - ((t - 1)*(s + t + 1))/4, ((t - 1)*(t - s + 1))/4 - ((s + 1)*(t - 1))/4, ((s + 1)*(t + 1))/4 + ((t + 1)*(s + t - 1))/4, ((s - 1)*(t + 1))/4 + ((t + 1)*(s - t + 1))/4, ((s - 1)*(t - 1))/2 + ((s + 1)*(t - 1))/2, -((t - 1)*(t + 1))/2, - ((s - 1)*(t + 1))/2 - ((s + 1)*(t + 1))/2, ((t - 1)*(t + 1))/2];
dNt=[ - ((s - 1)*(t - 1))/4 - ((s - 1)*(s + t + 1))/4, ((s + 1)*(t - 1))/4 + ((s + 1)*(t - s + 1))/4, ((s + 1)*(t + 1))/4 + ((s + 1)*(s + t - 1))/4, ((s - 1)*(s - t + 1))/4 - ((s - 1)*(t + 1))/4, ((s - 1)*(s + 1))/2, - ((s + 1)*(t - 1))/2 - ((s + 1)*(t + 1))/2, -((s - 1)*(s + 1))/2, ((s - 1)*(t - 1))/2 + ((s - 1)*(t + 1))/2];
...
det_J=abs(c*a-b*d);
for i=1:8
B(1,2*i-1)=(a*dNs(i))-(b*dNt(i));
B(2,2*i-1)=0;
B(3,2*i-1)=c*(dNt(i))-d*(dNs(i));
B(1,2*i)=0;
B(2,2*i)=c*(dNt(i))-d*(dNs(i));
B(3,2*i)=a*(dNs(i))-b*(dNt(i));
end


B=B/det_J;
B_element(:,:,j)=B;
Ke=(B'*D*B*tt*w*det_J)+Ke;
end
Ke;
B_Total{e}=B_element;
